...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="static">
            <div class="header">
                <br><br><br>
                <a href="#top"><h3 style="font-size:2em;margin-top:-1%;margin-left:2%;color:white;font-family:myFont2;">Symphony</h3></a>
                <!--*************************************************************************-->

                <ul>
                    <li><a  onclick="document.getElementById('login').style.display='block'" class="round blue"><span class="round">Login</span></a></li>
                    <li><a  onclick="document.getElementById('register').style.display='block'" class="round red"><span class="round">Sign Up</span></a></li>
                    <li><a  onclick="document.getElementById('feedback').style.display='block'" class="round green"><span class="round">Feedback</span></a></li>
                </ul>
                ...
                <!--*************************************************************************-->
                <div id="dropdown" style="margin-top:-7.5%;margin-left:82%;" onclick="drop()">
